...
begin  //PaintView
  ...
  if FCounter < 250 then
    begin
      ...
      Canvas.FillStyle := 'white';
      Canvas.FillTextF('Use IE, Chrome or Firefox.', 50, 100, Max_Int);
      ...
      Canvas.FillTextF('Try to keep the taxi on the road.', 50, 300, Max_Int);
      Canvas.FillTextF('Press Escape to exit.', 50, 350, Max_Int);
    end
  else
    begin
      if not reached then
