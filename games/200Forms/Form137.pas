...
procedure TForm137.InitializeForm;
begin
  inherited;
...
procedure TForm137.InitializeObject;
begin
  inherited;
  {$I 'Form137:impl'}
...
procedure TForm137.FormActivated;
Begin
  inherited;
...
initialization
  Forms.RegisterForm({$I %FILE%}, TForm137);
end.
