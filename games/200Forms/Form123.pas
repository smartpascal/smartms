...
procedure TForm123.InitializeForm;
begin
  inherited;
...
procedure TForm123.InitializeObject;
begin
  inherited;
  {$I 'Form123:impl'}
...
procedure TForm123.FormActivated;
Begin
  inherited;
...
initialization
  Forms.RegisterForm({$I %FILE%}, TForm123);
end.
